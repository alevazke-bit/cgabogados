...
class ensaf_recent_posts_widget extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct(
                ...
                'ensaf_recent_posts_widget',

                // Widget name will appear in UI
                esc_html__( 'Ensaf :: Recent Posts', 'ensaf' ),

                // Widget description
                array(
                    'classname'                     => '',
                    'customize_selective_refresh'   => true,
                    'description'                   => esc_html__( 'Add Recent Posts Widget', 'ensaf' ),
                )
            );
        }
                                    ...
                                    echo '<div class="media-img">';
                                        echo '<a href="'.get_the_permalink().'">';
                                            echo ensaf_img_tag( array(
                                                "url"   => esc_url( get_the_post_thumbnail_url( null, 'ensaf_80X80' ) ),
                                            ) );
                                        echo '</a>';
                                    echo '</div>';
                                }
        ...
        public function form( $instance ) {
           ...
           //Post title Count
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'post_count' ); ?>"><?php _e( 'Number of Posts to show:' ,'ensaf'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'post_title_count' ); ?>"><?php _e( 'Number of title word to show:' ,'ensaf'); ?></label>
    ...
    } // Class ensaf_recent_posts_widget ends here


    // Register and load the widget
    function ensaf_recent_posts_load_widget() {
        register_widget( 'ensaf_recent_posts_widget' );
    }
    add_action( 'widgets_init', 'ensaf_recent_posts_load_widget' );