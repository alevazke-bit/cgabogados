...
class ensaf_search_form_widget extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct(
                ...
                'ensaf_search_form_widget',

                // Widget name will appear in UI
                esc_html__( 'Ensaf :: Search Form', 'ensaf' ),

                // Widget description
                array(
                    'classname'                     => 'widget_search',
                    'customize_selective_refresh'   => true,
                    'description'                   => esc_html__( 'Add Search Form Widget', 'ensaf' ),
                )
            );
        }
        ...
        public function form( $instance ) {
            ...
            ?>
            <p>
                <label for="<?php echo $this->get_field_id( 'placeholder' ); ?>"><?php _e( 'Search:' ,'ensaf'); ?></label>
    ...
    } // Class ensaf_search_form_widget ends here


    // Register and load the widget
    function ensaf_search_form_load_widget() {
        register_widget( 'ensaf_search_form_widget' );
    }
    add_action( 'widgets_init', 'ensaf_search_form_load_widget' );