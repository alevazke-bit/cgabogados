...
class ensaf_offer_banner_widget extends WP_Widget {

        function __construct() {

            parent::__construct(
                // Base ID of your widget
                'ensaf_offer_banner_widget',

                // Widget name will appear in UI
                esc_html__( 'Ensaf :: Offer Banner Widget', 'ensaf' ),

                // Widget description
                array(
                    'customize_selective_refresh'   => true,
                    'description'                   => esc_html__( 'Add Offer Banner Widget', 'ensaf' ),
        ...
        public function widget( $args, $instance ) {
        	...
        	?>
            <div class="widget widget_banner" data-bg-src="<?php echo esc_url($banner_img_url ); ?>">
                <div class="widget-banner">
                    <h3 class="box-title"><?php echo esc_html( $banner_title ); ?></h3>
                    <div class="logo">
                        <?php 
                    ...
                    <p class="box-text"><?php echo esc_html( $banner_desc ); ?></p>
                    <h3 class="box-link"><a href="<?php echo esc_attr('tel:'.$phoneurl); ?>"><?php echo esc_html($banner_phone); ?></a></h3>
                    <?php if(!empty($button_text)): ?>
                        <a href="<?php echo esc_url( $button_url ); ?>" class="th-btn style2"><?php echo esc_html( $button_text ); ?><i class="far fa-arrow-right ms-2"></i></a>
                    <?php endif; ?>
                </div>
            </div>
        ...
        public function form( $instance ) {
        	...
        	?>
            <p>
                <label for="<?php echo $this->get_field_id( 'banner_img_url' ); ?>"><?php _e( 'Image URL:' ,'ensaf'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'banner_img_url2' ); ?>"><?php _e( 'Logo URL:' ,'ensaf'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'banner_title' ); ?>"><?php _e( 'Banner Title:' ,'ensaf'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'banner_desc' ); ?>"><?php _e( 'Banner Description:' ,'ensaf'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'banner_phone' ); ?>"><?php _e( 'Phone Number:' ,'ensaf'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'button_text' ); ?>"><?php _e( 'Button Text:' ,'ensaf'); ?></label>
                <input class="widefat" id="<?php echo $this->get_field_id( 'button_text' ); ?>" name="<?php echo $this->get_field_name( 'button_text' ); ?>" type="text" value="<?php echo esc_attr( $button_text ); ?>" />
            </p>
            <p>
                <label for="<?php echo $this->get_field_id( 'button_url' ); ?>"><?php _e( 'Button URL:' ,'ensaf'); ?></label>
    ...
    } // Class ensaf_offer_banner_widget ends here


    // Register and load the widget
    function ensaf_offer_banner_load_widget() {
        register_widget( 'ensaf_offer_banner_widget' );
    }
    add_action( 'widgets_init', 'ensaf_offer_banner_load_widget' );