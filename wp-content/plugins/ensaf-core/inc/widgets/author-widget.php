...
class ensaf_author_widget extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct(
                ...
                esc_html__( 'Ensaf :: Author Widget', 'ensaf' ),

                // Widget description
                array(
                    'customize_selective_refresh'   => true,
                    'description'                   => esc_html__( 'Add Author Widget', 'ensaf' ),
                    'classname'                     => 'no-class',
                )
            );
        ...
        public function form( $instance ) {
        	...
        	?>
            <p>
                <label for="<?php echo $this->get_field_id( 'author_img_url' ); ?>"><?php _e( 'Image URL:' ,'ensaf'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'about_name' ); ?>"><?php _e( 'Author Name:' ,'ensaf'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'about_bio' ); ?>"><?php _e( 'Author Bio:' ,'ensaf'); ?></label>
    ...
    } // Class ensaf_author_widget ends here


    // Register and load the widget
    function ensaf_author_load_widget() {
        register_widget( 'ensaf_author_widget' );
    }
    add_action( 'widgets_init', 'ensaf_author_load_widget' );