 ...
 *
 */
class ensaf_Button extends Widget_Base {

	public function get_name() {
		return 'ensafbutton';
	}
	public function get_title() {
		return __( 'Button', 'ensaf' );
	}
	...
	protected function register_controls() {
		...
		ensaf_general_fields($this, 'button_text', 'Button Text', 'TEXT', 'Button Text');
		ensaf_general_fields($this, 'button_extra_class', 'Button Extra Class', 'TEXT', '');
		ensaf_url_fields($this, 'button_url', 'Button URL');
		ensaf_general_fields($this, 'button_icon', 'Button Icon Class', 'TEXT', '');

		$this->add_control(
			'button_icon_position',
			[
				'label' 	=> __( 'Button Icon Position', 'ensaf' ),
				'type' 		=> Controls_Manager::SELECT,
				'default' 	=> '2',
				'options' 	=> [
					'1'  		=> __( 'Before Text', 'ensaf' ),
					'2' 		=> __( 'After Text', 'ensaf' ),
				],
			]
		);
		...
		$this->add_control(
			'button_space',
			[
				'label' => esc_html__( 'Button Icon Spacing (PX)', 'ensaf' ),
        ...
        $this->add_responsive_control(
			...
			[
				...
				'options' 		=> [
					...
					'center' 	=> [
						'title' 		=> __( 'Center', 'ensaf' ),
						'icon' 			=> 'eicon-text-align-center',
					],
					'right' 	=> [
						'title' 		=> __( 'Right', 'ensaf' ),
		...
		//------Button Style-------
		ensaf_button_style_fields($this, '10', 'Button Styling', '{{WRAPPER}} .th_btn', ['1']);
		ensaf_button2_style_fields($this, '11', 'Button Styling', '{{WRAPPER}} .th_btn', ['2']);
