...
if ( $max_value && $min_value === $max_value ) {
    ...
    $label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'ensaf' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'ensaf' );
    ?>
        ...
        <label class="screen-reader-text" for="<?php echo esc_attr( $input_id ); ?>"><?php echo esc_html( $label ); ?></label>
            ...
            <input
                ...
                title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'ensaf' ); ?>"
                size="4"
