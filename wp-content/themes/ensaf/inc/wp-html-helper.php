...
// image default alt
if( !function_exists( 'ensaf_img_default_alt' ) ){
	function ensaf_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'ensaf_img_tag' ) ){
	function ensaf_img_tag( array $args ){
...
// Anchor Tag
if( !function_exists( 'ensaf_anchor_tag' ) ){
	function ensaf_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'ensaf_heading_tag' ) ){
	function ensaf_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'ensaf_paragraph_tag' ) ){
	function ensaf_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'ensaf_span_tag' ) ){
	function ensaf_span_tag( array $args ){
