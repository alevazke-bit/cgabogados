...
function ensaf_pagination( $args = array() ) {
    ...
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => esc_html__( '&laquo;', 'ensaf' ),
        'next_string'     => esc_html__( '&raquo;', 'ensaf' ),
        'before_output'   => '',
        'after_output'    => ''
    );
    ...
    $args = wp_parse_args( 
        $args, 
        apply_filters( 'ensaf_pagination_defaults', $defaults )
    );
